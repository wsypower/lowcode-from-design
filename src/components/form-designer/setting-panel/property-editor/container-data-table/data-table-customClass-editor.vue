<template>
  <div>
    ...
    >
      <el-button type="primary" plain round @click="editButtonsColumn">{{
        i18nt('designer.setting.editAction')
      }}</el-button>
    </el-form-item>
      ...
      >
        ...
        <template #footer>
          <div class="dialog-footer">
            <el-button size="default" type="primary" @click="saveTableData">{{
              i18nt('designer.hint.confirm')
            }}</el-button>
            <el-button size="default" @click="dataDialogVisible = false">{{
    ...
    >
      ...
      >
        ...
        >
          ...
          <el-table-column
            :label="i18nt('designer.setting.alignTypeOfColumn')"
            width="100"
            prop="align"
          >
            <template #default="scope">
          ...
          >
            <template #default="scope">
              <el-button
                :disabled="scope.row.formatS !== 'render'"
        ...
        <template #footer>
          <div class="dialog-footer">
            <el-button size="default" type="primary" @click="colSubmit">{{
              i18nt('designer.hint.confirm')
            }}</el-button>
      ...
      >
        <el-form label-width="110" label-position="left" :model="optionModel">
          <el-row :gutter="8">
            ...
            <el-col :span="6">
              <el-form-item
                prop="buttonsColumnWidth"
                :label="i18nt('designer.setting.buttonsColumnWidth')"
              >
                <el-input-number
                  v-model="optionModel.buttonsColumnWidth"
                ></el-input-number>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item
                prop="buttonsColumnFixed"
                :label="i18nt('designer.setting.fixedColumn')"
              >
          ...
          >
            <template #item="{ element: btn, index: bIdx }">
              <el-row :gutter="8" class="button-row">
                ...
                <el-col :span="3">
                  <el-form-item
                    :prop="'operationButtons.' + bIdx + '.name'"
                  ...
                  >
                    <el-input
                      ...
                      :placeholder="
                        i18nt('designer.setting.operationButtonName')
                      "
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="3">
                  <el-form-item
                    :prop="'operationButtons.' + bIdx + '.label'"
                    :label="i18nt('designer.setting.operationButtonLabel')"
                  >
                    <el-input
                      v-model="btn.label"
                      :placeholder="
                        i18nt('designer.setting.operationButtonLabel')
                      "
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item
                    :prop="'operationButtons.' + bIdx + '.type'"
                    :label="i18nt('designer.setting.operationButtonType')"
                  >
                    <el-select
                      v-model="btn.type"
                      :placeholder="
                        i18nt('designer.setting.operationButtonType')
                      "
                    >
                ...
                <el-col :span="3">
                  <el-form-item
                    :prop="'operationButtons.' + bIdx + '.size'"
                    :label="i18nt('designer.setting.operationButtonSize')"
                  >
                    <el-select
                      v-model="btn.size"
                      :placeholder="
                        i18nt('designer.setting.operationButtonSize')
                      "
                    >
                ...
                <el-col :span="3">
                  <el-form-item
                    :prop="'operationButtons.' + bIdx + '.round'"
                ...
                <el-col :span="3">
                  <el-form-item
                    :prop="'operationButtons.' + bIdx + '.hidden'"
                ...
                <el-col :span="3">
                  <el-form-item
                    :prop="'operationButtons.' + bIdx + '.disabled'"
          ...
          <el-row :gutter="0">
            <el-col :span="4">
              <el-button
                ...
                >{{ i18nt('designer.setting.addOperationButton') }}</el-button
              >
            </el-col>
          </el-row>
        </el-form>
        <template #footer>
          <div class="dialog-footer">
            <el-button size="default" @click="showButtonsEditDialog = false">{{
