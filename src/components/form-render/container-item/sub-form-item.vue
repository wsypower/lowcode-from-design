    ...
    >
      <el-row class="header-row">
        ...
        >
          ...
          >
            <span v-if="!!subWidget.options.labelIcon" class="custom-label">
              <template v-if="subWidget.options.labelIconPosition === 'front'">
                <template v-if="!!subWidget.options.labelTooltip">
                  ...
                  >
                    <svg-icon
                      :icon-class="subWidget.options.labelIcon" /></el-tooltip
                  >{{ subWidget.options.label }}</template
                >
                <template v-else>
                  <svg-icon :icon-class="subWidget.options.labelIcon" />{{
